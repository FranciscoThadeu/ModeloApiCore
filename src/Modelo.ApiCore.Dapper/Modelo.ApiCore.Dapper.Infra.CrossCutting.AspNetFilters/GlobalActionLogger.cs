...
using Modelo.ApiCore.Dapper.Infra.CrossCutting.AspNetFilters.Models;
using Newtonsoft.Json;

namespace Modelo.ApiCore.Dapper.Infra.CrossCutting.AspNetFilters
{
    public class GlobalActionLogger : IActionFilter
    {
        ...
        public async void OnActionExecuted(ActionExecutedContext context)
        {
            ...
            if (_hostingEnviroment.IsProduction())
            {
                ...
                {
                    Version = "V1.0",
                    Application = context.HttpContext.Request.GetDisplayUrl(),
